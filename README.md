...
This repository enables you to performe the calculations shown in the manuscript: *Ohmer, M., Liesch, T., Wunsch, A., Spatio-temporal optimization of groundwater monitoring networks using data-driven sparse sensing methods [https://doi.org/10.5194/hess-26-4033-2022](https://doi.org/10.5194/hess-26-4033-2022)
